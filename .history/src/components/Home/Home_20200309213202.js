...
import { View,Image,Input,value,setValue, Text,Dimensions, SafeAreaView,StyleSheet,Button, TouchableOpacity, TextInput,KeyboardAvoidingView, SectionList,FlatList,StatusBar} from 'react-native';
      ...
      <View style={styles.listItem}>
        ...
        <View style={styles.body}>
          <View style={styles.horizontal}>
            ...
            <Text style={{paddingLeft:130,fontSize:12}}>{props.data.distance}
              KM
            </Text>
          </View>
            <View>
...
const HomeComponent = (props) => { 
  ...
  const BackAction = () => (<>
  <TouchableOpacity onPress={()=>{props.navigation.navigate('SearchScreen')}} icon={BackIcon} >
    <Text style={{fontSize:20,paddingLeft:10}}>Home</Text>
    </TouchableOpacity>
    <TopNavigationAction onPress={()=>{props.navigation.navigate('SearchScreen')}} icon={BackIcon}/>
    </>
  );
