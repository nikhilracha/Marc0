    ...
    <SafeAreaView>
      ...
      <View style={styles.con}>
        <TouchableOpacity style={styles.card}>
          ...
          <Text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</Text>
          {" "} {" "}{" "}{" "}{" "}{" "}{" "}{" "} 
          <MIcon name="map-marker" style={{fontSize:25,color:'#77b5fe'}}/><Text style={{fontSize:20}}>Location</Text>
          </Text>
          <Text>&nbsp;&nbsp;</Text>
          <View style={{borderBottomColor: 'gray',borderBottomWidth: 1}}/>
          <Text>&nbsp;&nbsp;</Text>
          <Text>
          <MIcon name="star" style={{fontSize:30,color:'orange'}}/><Text style={{fontSize:18,fontWeight:'bold'}}>4.7</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text>
          <MIcon name="car" style={{fontSize:22,color:'#77b5fe'}}/><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text>
          <MIcon name="air-conditioner" style={{fontSize:22}}/><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text>
          <MIcon name="shower-head" style={{fontSize:22}}/><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text>
          <MIcon name="currency-inr" style={{fontSize:22}}/><Text>&nbsp;&nbsp;</Text><Text>&nbsp;&nbsp;</Text>
          </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
