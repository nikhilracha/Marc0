...
export const Details = (props) => {
  ...
  return( 
    ...
    <View style={{padding:20}}>
      ...
      <Text>&nbsp;&nbsp;</Text>
      <Text style={{fontSize:18,color:'lightblack',fontWeight:'400',alignContent:'center'}}>
      ...
      <View style={{borderBottomColor: 'gray',borderBottomWidth: 1}}/>
      <Text>&nbsp;&nbsp;</Text>
      <Text style={styles.TextStyle} onPress={ ()=> Linking.openURL('httpshttps://www.google.com/maps/dir/17.3957164,78.53201/Fit+Dock,+Pragathi+Nagar+Main+Road,+opposite+D+Mart,+Ramanthapur,+Hyderabad,+Telangana+500013/@17.3986505,78.5294117,20.62z/data=!4m9!4m8!1m1!4e1!1m5!1m1!1s0x3bcb9916c5970bb9:0xb34db7ca547d033!2m2!1d78.5384766!2d17.3999671://google.com') } >
        Location        </Text>
  </View>
  </ScrollView>
