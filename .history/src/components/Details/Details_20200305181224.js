...
export const Details = (props) => {
  ...
  return( 
    ...
    <View style={{padding:20}}>
      ...
      <Text style={{fontSize:18,color:'mediumpurple',fontWeight:'500',alignContent:'center'}}>
        Fit Dock help of certified trainers and nutritionists, and through the systematic continuous up gradiation
        of training modules based on the clients comfort and capability.Fit Dock indeed helps take a body positive
        and comprehensive step towards acheiving fitness.Depending on customer's specific needs and goals,from
