  ...
  return( 
    ...
    <View style={{padding:20}}>
      ...
      <Text style={{fontSize:18,color:'mediumpurple',fontWeight:'500',alignContent:'center'}}>
        Fit Dock help of certified trainers and nutritionists, and through the systematic continuous up gradiationof training modules based on the clients comfort and capability.Fit Dock indeed helps take a body positive
