...
class CardComponent extends React.Component {
    constructor() {
        ...
        this.renderBody = (style) => {
            return (React.createElement(View, { style: [styles.body, style] }, this.props.children));
        };
    ...
    render() {
        ...
        return (React.createElement(TouchableOpacity, Object.assign({ activeOpacity: 1.0 }, restProps, { style: [container, styles.container, style] }),
            header,
