...
export const withStyles = (Component, createStyles) => {
    class Wrapper extends React.Component {
        ...
        render() {
            ...
            return (React.createElement(ThemeContext.Consumer, null, (theme) => (React.createElement(ThemedElement, { theme: theme }))));
        }
    }
